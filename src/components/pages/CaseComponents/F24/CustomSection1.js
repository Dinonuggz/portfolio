...
const CustomSection1= () => {
    return (
        <div>
         <p>Fitness 24/7 is one of the fastest growing fitness chains in Scandinavia, their mission is to keep expanding globally and to become an industry leader providing affordable gym memberships with high consumer value. With a gym membership for over for 4 years and knowing several members I came to notice potential user experience flaws in their current app.</p>
        <div className="mt-6">
        <h2 className="text-2xl font-bold mb-4">Perceived pain-points</h2>
            <div className="shadow p-4 bg-gray-100 mb-4 rounded">   
        <h2 className="font-bold"> <FontAwesomeIcon icon={faMinusCircle} className="mr-2 text-red-500"/> Class Booking</h2>
        ...
        <div className="shadow p-4 bg-gray-100 rounded">
        <h2 className="font-bold"> <FontAwesomeIcon icon={faMinusCircle} className="mr-2 text-red-500"/> What if you only use the gym facilities?</h2>
