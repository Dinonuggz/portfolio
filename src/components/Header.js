...
const Header = () => {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row items-start justify-between sm:pt-8 md:pt-16 font-hero font-black text-black w-10/12 md:w-9/12 mx-auto">
            ...
            <motion.h1 variants={containerVariants} initial="hidden" animate="visible" className="text-4xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-6xl mt-8 md:mt-1 lg:mt-12 md:mb-4">{content.header.text[0]} {content.header.text[1]}
            <h1 className="text-xl text-left text-green-400 sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mt-2 md:mt-4">UX/UI designer with <br></br><span span className="text-green-400">Industrial design background.</span></h1></motion.h1>
